...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        with context.begin_transaction():
            ...
            connection.execute(engine_from_config(config.get_section(config.config_section, {}), prefix="sqlalchemy.", poolclass=pool.NullPool).dialect.statement_compiler.dialect.statement_compiler(None, None).dialect.statement_compiler.dialect.statement_compiler.dialect.execute("CREATE EXTENSION IF NOT EXISTS vector;")) # Will use a direct approach
